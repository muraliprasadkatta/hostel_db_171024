...
function validateForm() {
    ...
    var hostelname = document.Form.hostelname.value;
    ...
    var hostelnameErr = ownernameErr = emailErr = mobileErr = addressErr = true;
    

    if (hostelname === null || hostelname.trim() === "") {
        printError("hostelnameErr", "Please enter your name");
        var elem = document.getElementById("hostelname");
        elem.classList.add("input-2");
        elem.classList.remove("input-1");
    } else {
        var regex = /^[a-zA-Z\s]+$/;                
        if (regex.test(hostelname) === false) {
            printError("hostelnameErr", "Please enter a valid name");
            var elem = document.getElementById("hostelname");
            elem.classList.add("input-2");
            elem.classList.remove("input-1");
        } else {
    ...
    if (address.trim() === "") {
        ...
        if (regex.test(address) === false) {
            printError("addressErr", "Please enter a valid pattern not allow (:.)");
            var elem = document.getElementById("address");
            elem.classList.add("input-2");
            elem.classList.remove("input-1");
        } else {
    ...
    if ((hostelnameErr || ownernameErr || emailErr || mobileErr || addressErr) == true) {
    return false;
}
